...
from scaledRunningMedian import mp_MedScheduler2, mp_MedDataLoader
from combiners import MedCombiner, MedCombiner2
...
def runningMedianManager():
    ...
    intermediateResults = mp_MedScheduler2(textPool)
    ...
    finalResults = MedCombiner2(intermediateResults)

    # Results Reporting Stage
    # writing the final results to a text or html file depending on the flag writeInHTML
    medWriter(outputPath, finalResults, "mp2_", write_in_html= writeInHTML)
